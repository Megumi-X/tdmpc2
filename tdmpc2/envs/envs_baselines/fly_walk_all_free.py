...
class FlyWalkAllFreeEnv(MujocoEnv, utils.EzPickle):
    ...
    def sim(self, ctrl):
        ...
        if max_height < 5 or min_height > 5:
            ...
            reward_up *= -1
            reward_fwd *= 0
        elif self.min_heights[xpos_index + 25] > zposafter + 5:
            reward_fwd *= 0
        ...
        if ang >= max_ang:
            ...
            termination = True
        # if x_ang >= max_x_ang:
        #     print("X Angle out of bound while walking!")
        #     print("x angle: ", x_ang)
        #     termination = True
        if collision:
    ...
    def reset_terrain(self):
        ...
        self.ceils_start_pos = [-1000, ceil_1_start_pos]
        self.ceils_end_pos = [ceil_0_end_pos, 1000]
        self.mounts_start_pos = [mount_0_start_pos]
        self.mounts_end_pos = [mount_0_end_pos]
